  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/file/{{ $file_id }}/draw_save" method="POST" class="form-horizontal" id="form_update">
          @csrf
          <label>コメント</label>
          ...
          <div class="form-group">
            <button type="submit" class="btn btn-primary" form="form_update">保存</button>
